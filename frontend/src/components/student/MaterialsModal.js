...
import { FileText, Download, Eye, Search, Loader, X } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export function MaterialsModal({ open, onOpenChange }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-5xl max-h-[90vh] overflow-y-auto bg-white">
        <DialogHeader>
          <DialogTitle className="text-2xl font-semibold text-gray-900">Study Materials</DialogTitle>
                  ...
                  >
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => materialAPI.download(material.id, material.title)}
                        className="flex-1 rounded-lg"
                      >
